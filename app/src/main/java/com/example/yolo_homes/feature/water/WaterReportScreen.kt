...
fun WaterReportScreen(
    ...
    fun buildPdfFile(): File {
        ...
        return PdfExporter.exportTable(
            context = context,
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    ...
                    // No icon-only download button here anymore — the
                    // labeled PdfActionsRow below is the one clear,
                    // learnable way to get a PDF, on every screen.
                }
            )
        }
    ) { padding ->
