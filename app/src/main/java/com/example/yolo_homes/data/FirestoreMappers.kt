...
fun DocumentSnapshot.toSettings(): AppSettings {
    ...
    return AppSettings(
        ...
        billingMethod = if (strOrNull("billingMethod") == "tiered") "tiered" else "flat",
        ...
        freeLitersMonthly = if (contains("freeLitersMonthly")) double("freeLitersMonthly") else d.freeLitersMonthly,
        tieredRatePerLiter = if (contains("tieredRatePerLiter")) double("tieredRatePerLiter") else d.tieredRatePerLiter,
